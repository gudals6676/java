...
update STUDENT set STU_PW = '정지윤' where STU_ID = 'b1';
...
insert into Board values('01','a1','Sadmin','파이썬 공부','0');
insert into Board values('02','a1','Sadmin','파이썬 공부 2차','0');
insert into Board values('03','a2','Sadmin','디비 공부','0');
insert into Board values('04','a3','Sadmin','자바 공부','0');
insert into Board values('05','admin','b1','파이썬 보강','0');
insert into Board values('06','admin','b2','디비 보강','0');
insert into Board values('07','admin','b3','자바 보강','0');
